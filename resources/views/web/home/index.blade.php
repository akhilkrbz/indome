                ...
                <nav class="m_bottom_10">
                    <ul class="hr_list tabs_list second_font tt_uppercase fs_large fw_light">
                        <li data-animation="fadeInRight" class="m_right_40 m_xs_right_10 animated hidden"><a
                                class="color_light color_dark_hover" href="#tab-1">Featured</a></li>
                        <li data-animation="fadeInLeft" data-animation-delay="100"
                            class="m_right_40 m_xs_right_10 animated hidden"><a class="color_light color_dark_hover"
                                href="#tab-2">New</a></li>
                        <li data-animation="fadeInLeft" data-animation-delay="200"
                            class="m_right_40 m_xs_right_10 animated hidden"><a class="color_light color_dark_hover"
                                href="#tab-3">Specials</a></li>
                        <li data-animation="fadeInLeft" data-animation-delay="300"
                            class="m_right_40 m_xs_right_10 animated hidden"><a class="color_light color_dark_hover"
                                href="#tab-4">Hit</a></li>
                        <li data-animation="fadeInLeft" data-animation-delay="400"
                            class="m_right_40 m_xs_right_10 animated hidden"><a class="color_light color_dark_hover"
                                href="#tab-5">Random</a></li>
                        <li data-animation="fadeInLeft" data-animation-delay="500"
                            class="m_right_40 m_xs_right_10 animated hidden"><a class="color_light color_dark_hover"
                                href="#tab-6">Rated</a></li>
                    </ul>
                </nav>
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-md-6 col-sm-6">
                            <div class="row">
                                                ...
                                                <div class="row t_sm_align_c">
                                                        ...
                                                        <div class="clearfix m_sm_bottom_3 d_sm_inline_b">
                                                            <button
                                                                class="button_type_8 grey state_2 tr_delay color_dark t_align_c vc_child f_left m_right_3 tooltip_container relative"><i
                                                                    ...
                                                                    data-show="fadeInDown" data-hide="fadeOutUp">Add to
                                                            ...
                                                            <button data-popup="#quick_view"
                                                                ...
                                                                class="button_type_8 grey state_2 tr_delay color_dark t_align_c vc_child f_left m_right_3 tooltip_container relative m_sm_right_0"><i
                                                                    ...
                                                                    class="tooltip top fs_small color_white hidden animated"
                                                                    data-show="fadeInDown" data-hide="fadeOutUp">Quick
                                                                    View</span></button>
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-4 col-md-4 t_align_r t_sm_align_c">
                                                        <button data-popup="#add_to_cart_popup"
                                                            data-popup-transition-in="bounceInUp"
                                                            data-popup-transition-out="bounceOutUp"
                                                            class="button_type_8 tr_all lbrown color_dark t_align_c vc_child tooltip_container relative"><i
                                                                class="fa fa-shopping-cart fs_large d_inline_m"></i><span
                                                                class="tooltip top fs_small color_white hidden animated"
                                                                data-show="fadeInDown" data-hide="fadeOutUp">Add to
                                                                Cart</span></button>
                                                    </div>
                                        ...
                                        <figcaption class="bg_white relative">
                                            <div class="row">
                                                <div class="col-lg-7 col-md-7 m_bottom_7">
                                                    <a class="second_font sc_hover d_xs_block" href="#">Sed in lacus ut
                                                        enim</a>
                                                    <a href="#" class="fw_light color_light sc_hover">Chaises</a>
                                                </div>
                                                <div
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 w_mxs_full m_xs_bottom_30 animated hidden"
                                    data-animation="fadeInDown" data-animation-delay="150">
                                    <!--product-->
                                    <figure
                                        class="product_item relative c_image_container frame_container t_sm_align_c r_image_container">
                                        <!--image & buttons & label-->
                                        ...
                                        <figcaption class="bg_white relative">
                                            <div class="row">
                                                <div class="col-lg-7 col-md-7 m_bottom_7">
                                                    <a class="second_font sc_hover d_xs_block" href="#">Eget elementum
                                                        vel</a>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6">
                            <div class="row">
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 w_mxs_full m_mxs_bottom_30 animated hidden"
                                    data-animation="fadeInDown" data-animation-delay="300">
                                    <!--product-->
                                    <figure
                                        class="product_item relative c_image_container frame_container t_sm_align_c r_image_container">
                                        <!--image & buttons & label-->
                                        ...
                                        <figcaption class="bg_white relative">
                                            <div class="row">
                                                <div class="col-lg-8 col-md-8 m_bottom_7">
                                                    <a class="second_font sc_hover d_xs_block" href="#">Mauris accumsan
                                                        nulla</a>
                                                    <a href="#" class="fw_light color_light sc_hover">Beds</a>
                                                </div>
                                                <div
                                                    class="col-lg-4 col-md-4 color_light fs_large second_font t_align_r t_sm_align_c m_bottom_5">
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 w_mxs_full animated hidden"
                                    data-animation="fadeInDown" data-animation-delay="450">
                                    <!--product-->
                                    <figure
                                        class="product_item relative c_image_container frame_container t_sm_align_c r_image_container">
                                        <!--image & buttons & label-->
                                        <div class="relative">
                                            ...
                                            <div
                                                ...
                                                <i class="d_inline_m">Out Of<br>Stock!</i></div>
                                            <div class="product_buttons_container bg_white tr_all">
                                                <div class="row">
                                                    <div class="col-lg-8 col-md-8">
                                                        <div class="clearfix d_sm_inline_b t_sm_align_c m_sm_bottom_3">
                                        ...
                                        <figcaption class="bg_white relative">
                                            <div class="row">
                                                <div class="col-lg-7 col-md-7 m_bottom_7">
                                                    <a class="second_font sc_hover d_xs_block" href="#">Praesent justo
                                                        dolor</a>
                                                    <a href="#" class="fw_light color_light sc_hover">Tables</a>
                                                </div>
                                                <div
                                                    class="col-lg-5 col-md-5 t_sm_align_c color_light fs_large second_font t_align_r m_bottom_5">
