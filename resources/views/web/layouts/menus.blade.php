                        ...
                        <div class="clearfix f_right f_xs_none d_xs_inline_b m_xs_bottom_15 t_xs_align_l">
                            ...
                            <div class="f_right m_right_3 relative transform3d">
                                <button class="button_type_1 tr_all second_font color_dark grey state_2"
                                    ...
                                    <img src="images/flag_en.jpg" alt="" class="d_inline_m m_right_10"><i
                ...
                <div class="col-lg-9 col-md-9">
                    ...
                    <nav role="navigation" class="d_xs_none">
                        <ul class="main_menu relative hr_list second_font fs_medium">
                            <li class="current">
                                <a href="index.html" class="tt_uppercase tr_delay">Home <i
                                        class="fa fa-caret-down tr_inherit d_inline_m m_left_5"></i></a>
                                <!--sub menu (second level)-->
                                <ul class="sub_menu bg_grey_light tr_all">
                                    <li class="current"><a href="index.html">Home v1</a></li>
                            ...
                            <li>
                                <a href="index.html" class="tt_uppercase tr_delay">Sliders <i
                            ...
                            <li>
                                <a class="tt_uppercase tr_delay">Shop <i
                                        class="fa fa-caret-down tr_inherit d_inline_m m_left_5"></i></a>
                                <div class="mega_menu bg_grey_light tr_all">
                                    <div class="row">
                                        <section class="col-lg-3 col-md-3 col-sm-3 m_xs_bottom_15">
                                            <h6 class="color_dark m_bottom_13"><b class="second_font ">Living Rooms</b>
                                            </h6>
                                        ...
                                        <section class="col-lg-3 col-md-3 col-sm-3 m_xs_bottom_15">
                                            ...
                                            <ul class="mega_menu_list">
                                                ...
                                                <li><a href="#" class="d_block sc_hover tr_delay">Dressers/Chests</a>
                                                </li>
                                                <li><a href="#" class="d_block sc_hover tr_delay">Nightstands</a></li>
                                            </ul>
                                        </section>
                                        <section class="col-lg-3 col-md-3 col-sm-3 m_xs_bottom_15">
                                            <h6 class="color_dark m_bottom_13"><b class="second_font ">Dining Rooms</b>
                                            </h6>
                                            ...
                                            <ul class="mega_menu_list">
                                                ...
                                                <li><a href="#" class="d_block sc_hover tr_delay">China Cabinets</a>
                                                </li>
                                            </ul>
                                        </section>
                                        <section class="col-lg-3 col-md-3 col-sm-3 m_xs_bottom_15">
                                            <h6 class="color_dark m_bottom_13"><b class="second_font ">Home Office</b>
                                            </h6>
                                            <img src="images/mega_menu_img_4.jpg" alt="" class="m_bottom_3">
                                            <ul class="mega_menu_list">
                                                <li><a href="#" class="d_block sc_hover tr_delay">Desks &amp; Tables</a>
                                                </li>
                                                <li><a href="#" class="d_block sc_hover tr_delay">Office Chairs</a></li>
                                                <li><a href="#" class="d_block sc_hover tr_delay">Workspace Storage</a>
                                                </li>
                                            </ul>
                                        </section>
                                    </div>
                            ...
                            <li>
                                <a href="portfolio_1_column_with_sidebar.html" class="tt_uppercase tr_delay">Portfolio
                                    <i class="fa fa-caret-down tr_inherit d_inline_m m_left_5 m_md_left_2"></i></a>
                                <!--sub menu (second level)-->
                                <ul class="sub_menu bg_grey_light tr_all">
                                    <li>
                                        ...
                                        <ul class="sub_menu bg_grey_light tr_all">
                                            <li><a href="portfolio_1_column_with_sidebar.html">1 column with sidebar</a>
                                            </li>
                                            <li><a href="portfolio_2_columns.html">2 columns</a></li>
                                            <li><a href="portfolio_3_columns.html">3 columns</a></li>
                                            <li><a href="portfolio_3_columns_with_sidebar.html">3 columns with
                                                    sidebar</a></li>
                                    ...
                                    <li>
                                        ...
                                        <!--sub menu (third level)-->
                                        <ul class="sub_menu bg_grey_light tr_all">
                                            <li><a href="portfolio_single_project_v1.html">Single project page v1</a>
                                            </li>
                                            <li><a href="portfolio_single_project_v2.html">Single project page v2</a>
                                            </li>
                                            <li><a href="portfolio_single_project_v3.html">Single project page v3</a>
                                            </li>
                                            <li><a href="portfolio_single_project_video_list.html">Single project with
                                                    video list</a></li>
                                            <li><a href="portfolio_single_project_video_slider.html">Single project with
                                                    video slider</a></li>
                                        </ul>
                                    </li>
                                </ul>
                            ...
                            <li>
                                <a href="pages_category_grid.html" class="tt_uppercase tr_delay">Pages <i
                                        class="fa fa-caret-down tr_inherit d_inline_m m_left_5 m_md_left_2"></i></a>
                                <ul class="sub_menu bg_grey_light tr_all">
                            ...
                            <li>
                                <a href="features_elements.html" class="tt_uppercase tr_delay">Features <i
                                        class="fa fa-caret-down tr_inherit d_inline_m m_left_5 m_md_left_2"></i></a>
                                <ul class="sub_menu bg_grey_light tr_all">
                            ...
                            <li>
                                <a href="blog.html" class="tt_uppercase tr_delay">Blog <i
                                        class="fa fa-caret-down tr_inherit d_inline_m m_left_5 m_md_left_2"></i></a>
                                <ul class="sub_menu bg_grey_light tr_all">
                    ...
                    <ul class="hr_list si_list shop_list f_right f_sm_none d_sm_inline_b t_sm_align_l">
                        ...
                        <li class="relative open_mini_shopping_cart">
                            <button class="color_dark active_lbrown tr_all" data-open-dropdown="#shopping_cart">
                                ...
                                <b class="second_font fs_small d_inline_b m_left_10">$355</b>
                            </button>
                            <div id="shopping_cart" data-show="fadeInUp" data-hide="fadeOutDown"
                                class="bg_grey_light dropdown animated">
                                ...
                                <ul class="shopping_cart_list m_bottom_4">
                                    <li class="relative">
                                        <div class="clearfix lh_small">
                                            <a href="#" class="f_left m_right_10 d_block"><img src="images/sc_img_1.jpg"
                                                    alt=""></a>
                                            <a href="#"
                                                class="fs_medium second_font color_dark sc_hover d_block m_bottom_4">Cursus
                                                eleifend elit aenean</a>
                                            <p class="fs_medium">1 x <b class="color_dark">$499.00</b></p>
                                        </div>
                                        <hr class="divider_white m_top_15 m_bottom_0">
                                        <span
                                            class="close fs_small color_light tr_all color_dark_hover fw_light">x</span>
                                    </li>
                                    <li class="relative">
                                        <div class="clearfix lh_small">
                                            <a href="#" class="f_left m_right_10 d_block"><img src="images/sc_img_2.jpg"
                                                    alt=""></a>
                                            <a href="#"
                                                class="fs_medium second_font color_dark sc_hover d_block m_bottom_4">Auctor
                                                wisi et urna</a>
                                    ...
                                    <li class="relative">
                                        <div class="clearfix lh_small">
                                            <a href="#" class="f_left m_right_10 d_block"><img src="images/sc_img_3.jpg"
                                                    alt=""></a>
                                            <a href="#"
                                                class="fs_medium second_font color_dark sc_hover d_block m_bottom_4">Aliquam
                                                erat volut</a>
                                ...
                                <ul class="fs_medium second_font color_dark m_bottom_15">
                                    <li><span class="d_inline_b total_title">Tax:</span><span
                                            class="fw_light">$0.00</span></li>
                                    <li><span class="d_inline_b total_title">Discount:</span><span
                                            class="fw_light">$37.00</span></li>
                                    <li><b><span class="d_inline_b total_title">Total:</span>$999.00</b></li>
                                </ul>
                                <a href="#" role="button"
                                    class="button_type_2 tt_uppercase fs_medium second_font d_block t_align_c black state_2 m_bottom_5">View
                                    Cart</a>
                                <a href="#" role="button"
                                    class="t_align_c tt_uppercase w_full second_font d_block fs_medium button_type_2 lbrown tr_all">Checkout</a>
                            </div>
                        </li>
                    </ul>
                </div>
