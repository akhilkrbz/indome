                            ...
                            <div class="wrapper">
                                ...
                                <div class="product_thumbnails_wrap relative">
                                    <div class="owl-carousel" id="thumbnails" data-nav="thumbnails_product_"
                                        ...
                                        <a href="#" data-image="{{ asset('uploads/products/' . $product->id . '/' . $image->filename) }}"
                                            data-zoom-image="{{ asset('uploads/products/' . $product->id . '/' . $image->filename) }}" class="d_block">
                                            <img src="{{ asset('uploads/products/' . $product->id . '/' . $image->filename) }}" alt="">
                                        </a>
                                        @endforeach
